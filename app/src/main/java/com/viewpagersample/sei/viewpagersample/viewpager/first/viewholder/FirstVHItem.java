...
public class FirstVHItem extends FirstVH {

    @BindView(R.id.first_controller_vh_item) TextView textView;
    private FirstController firstController;

    public FirstVHItem(ViewGroup parent, FirstController firstController) {
        super(LayoutInflater.from(parent.getContext()).inflate(R.layout.first_vh_item, parent,
                false));
