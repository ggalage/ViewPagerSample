...
public class ThirdVHItem extends ThirdVH{

    @BindView(R.id.third_controller_vh_item) TextView textView;
    private ThirdController thirdController;

    public ThirdVHItem(ViewGroup parent, ThirdController thirdController) {
        super(LayoutInflater.from(parent.getContext()).inflate(R.layout.third_vh_item, parent,
                false));
